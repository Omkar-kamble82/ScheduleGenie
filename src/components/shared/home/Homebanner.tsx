...
const Homebanner = () => {
  return (
    <div className="h-screen flex flex-col justify-center items-center text-center pt-[4vh] xl:pt-[15vh] bg-[#f1f1f1]">
      <span className="mx-[6px] max-w-[840px] lg:mx-auto flex flex-col items-center justify-center">
        ...
        <Button className="bg-primary text-white font-bold hover:bg-primary/80 mt-[15px]">Get started</Button>
      </span>
    </div>
  )
}
