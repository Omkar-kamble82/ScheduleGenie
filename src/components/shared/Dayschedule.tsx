  ...
  return (
    <div className="bg-[#c9c9c9] shadow-2xl p-3 rounded-3xl my-[25px]">
        ...
        { 
            props.day.morning && (
            <>
                <div className="text-yellow-800 font-bold text-xl ml-[15px] mt-[10px]">Morning</div>
                {props.day.morning.map(t => (
                <div key={t.task} className="ml-[30px] mt-[5px] shadow-md">
        ...
        { 
            props.day.afternoon && (
            <>
            <div className="text-yellow-800 font-bold text-xl ml-[15px] mt-[10px]">Afternoon</div>
