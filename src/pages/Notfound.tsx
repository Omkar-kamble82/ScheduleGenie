  ...
  return (
    <div className="h-[91vh] w-screen flex justify-center items-center bg-white">
        <div className="flex justify-center flex-col items-center h-[400px] w-[400px] px-[10px]">
            ...
            <a href="/trips" className="rounded-md mt-[15px] flex gap-1 items-center text-[white] bg-primary px-6 py-2.5 text-lg font-semibold hover:opacity-90 transition-all hover:duration-700">
